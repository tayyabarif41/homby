...
import { ContactFormComponent } from '../../../hebrew/shared/contact-form/contact-form.component';
...
@NgModule({
  declarations: [ContactFormComponent,ApartComponent, ContractorComponent, ShoppingComponent, MortgageComponent, ArchitectsComponent, CompareComponent, UpdatesBenefitsComponent, HomeComponent, BuyComponent, LayoutComponent],
  imports: [
